...
light_t *t_lspr[NUMSPRITES] =
{
	...
	&lspr[NOLIGHT],     // SPR_WPLD

	// Stalagmites
	&lspr[NOLIGHT],     // SPR_STG0
	&lspr[NOLIGHT],     // SPR_STH1
	&lspr[NOLIGHT],     // SPR_STH2
	&lspr[NOLIGHT],     // SPR_STH3
	&lspr[NOLIGHT],     // SPR_STH4
	&lspr[NOLIGHT],     // SPR_STH5
	&lspr[NOLIGHT],     // SPR_STH6
	&lspr[NOLIGHT],     // SPR_STH7
	&lspr[NOLIGHT],     // SPR_STH8
	&lspr[NOLIGHT],     // SPR_STH9
