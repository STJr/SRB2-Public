...
FUNCMATH int G_TicsToHours(tic_t tics);
FUNCMATH int G_TicsToMinutes(tic_t tics, boolean full);
FUNCMATH int G_TicsToSeconds(tic_t tics);
FUNCMATH int G_TicsToCentiseconds(tic_t tics);
FUNCMATH int G_TicsToMilliseconds(tic_t tics);
